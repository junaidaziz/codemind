      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          ...
          <div className="col-span-1 md:col-span-2">
            <Link href="/" className="flex items-center space-x-2 mb-4 group">
              ...
              <span className="text-xl font-bold text-white">CodeMind</span>
            </Link>
            <p className="text-gray-400 mb-4 max-w-md">
              AI-powered developer assistant that helps you understand, analyze, and work with your codebase more efficiently.
            </p>
        ...
        <div className="pt-8 border-t border-gray-800 flex flex-col md:flex-row items-center justify-between">
          <p className="text-gray-400 text-sm">
            © {currentYear} CodeMind. All rights reserved.
          </p>
